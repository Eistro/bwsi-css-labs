...
This module contains unit tests for the simple_calculator function
defined in lab_1b.py.
"""
...
def test_addition():
    ...
    # Test for negative and positive number
    assert simple_calculator("add", -2, 2) == 0
    # Test for zero addition
...
def test_division():
    ...
    # Test for division resulting in float
...
def test_invalid_operation():
    with pytest.raises(
        ValueError,
        match="Invalid operation. Please choose from 'add', 'subtract', 
        'multiply', or 'divide'.",
    ):
